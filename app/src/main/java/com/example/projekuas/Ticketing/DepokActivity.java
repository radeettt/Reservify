...
import com.example.projekuas.CinemaSelect.CinemaSelect;
        ...
        autoCompleteTxt.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                ...
                if (item.equals("JAKARTA")) {
                    ...
                    Intent intent = new Intent(DepokActivity.this, JakartaActivity.class);
                    startActivity(intent);
                }
            }
        });
    }
    public void goToCinemaSelect(View view) {
        Intent intent = new Intent(this, CinemaSelect.class);
        startActivity(intent);
    }
